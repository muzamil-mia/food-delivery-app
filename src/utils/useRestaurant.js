...
const useRestaurant = (resId) => {
    ...
    async function getRestaurantInfo() {
        try {
            ...
            /// iNSTEAD OF DOING IT IN THE ABOVE WAY WE CAN OPTIMIZE IT WE WILL PLACE THE API IN CONSTANTS IN CONSTANTS AS NAMED EXPORT AND FROM THERE WE WILL IMPORT IT THE BELOW WAY
