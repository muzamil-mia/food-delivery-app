...
// console.log( {name, cuisines, cloudinaryImageId, avgRating, slaString, costForTwoString, id, setRestaurants})
  // const {  } = props;
  ...
  return (
    <div className="basis-[250px] mob:basis-[150px] p-2.5 mb-2.5 hover:shadow">
      ...
      <div className="">
        ...
        <p className="text-gray-dark text-xs w-4/5overflow-hidden h-[32px]">{cuisines.join(", ")}</p>
