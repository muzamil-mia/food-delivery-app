...
class BlogClass extends React.Component {
    ...
    async componentDidMount() {
        ...
        const response = await fetch(Github_API_User + this.props.name);
        const blog_user_data = await response.json();

        const repo_data = await fetch(Github_API_User + this.props.name + "./repos");
            ...
            <div className="flex flex-col gap-5">
                <div className="flex gap-5 card-container mob:flex-col mob:items-center">
                    ...
                    <div className="">
                        ...
                        <div className="flex gap-2 mob:gap-2">
                ...
                <div className="flex flex-col p-5">
                    <h2 className="text-xl mt-2.5 text-title mb-2.5 font-bold">
